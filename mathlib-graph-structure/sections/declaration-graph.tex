...
The theorem--premise graph $G_{\mathrm{thm}}$ is a more faithful record of mathematical reasoning than the import graph $G_{\mathrm{module}}$. It dissolves the module boundary, exposing the individual logical dependencies that file-level analysis aggregates away. Our analysis of $G_{\mathrm{thm}}$ yields three central findings.
