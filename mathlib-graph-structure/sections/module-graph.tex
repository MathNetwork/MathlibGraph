...
Having defined the module-name tree $T$ and the import graph $G_{\mathrm{import}}$, and identified the 17.5\% redundancy gap between $G_{\mathrm{import}}$ and its transitive reduction (\S\ref{sec:transitive-reduction}), we now ask: \emph{what kind of network does formalization produce, and how does it relate to the cognitive classification encoded in $T$?}
