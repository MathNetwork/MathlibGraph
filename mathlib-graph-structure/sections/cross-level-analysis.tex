...
The containment analysis of \S\ref{sec:containment-decay} measured how much declaration-level dependency traffic stays within namespace boundaries (see also Figure~\ref{fig:ns-depth-grouping}). We can now compare this with module cohesion to assess the relative constraining power of the two human organizational systems at the declaration level.
