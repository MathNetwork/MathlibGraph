...
\begin{remark}
$T$ and the import graph $G_{\mathrm{import}}$ (defined in Section~\ref{sec:import-graph}) are distinct structures on the same vertex set $\mathcal{M}$. In $T$, edges connect a module to its namespace parent; in $G_{\mathrm{import}}$, edges reflect explicit \texttt{import} dependencies. Import edges need not respect the namespace hierarchy.
\end{remark}
