...
Do the three graphs share common statistical signatures, or does each level have its own structural character? The answer bears directly on the central tension of this paper: universal patterns---such as heavy-tailed degree distributions or scale-free\xinze{Replace ``scale-free'' with ``heavy-tailed / hub-dominated''---scale-free is contested and our data shows lognormal fits better} vulnerability---point to intrinsic features of mathematical dependency (product), while level-specific features---such as the bounded out-degree of proofs or the depth compression of the module graph---reveal cognitive and linguistic constraints imposed by the production process.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{analysis/module_centrality_indeg_pr.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{analysis/module_centrality_indeg_betw.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{analysis/module_centrality_betw_pr.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{analysis/thm_centrality_indeg_pr.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{analysis/thm_centrality_indeg_betw.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{analysis/thm_centrality_betw_pr.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{analysis/ns_centrality_indeg_pr.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{analysis/ns_centrality_indeg_betw.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{analysis/ns_centrality_betw_pr.pdf}
...
Figure~\ref{fig:module-robustness} shows the progressive removal curves. Under random removal, the giant component degrades gracefully---removing $20\%$ of modules leaves $80\%$ connected. Under targeted attack on the highest-PageRank modules, the same $20\%$ removal reduces the giant component to $58\%$, a $22$-percentage-point gap that grows with the removal fraction. The curve confirms the scale-free\xinze{Same: ``scale-free'' $\to$ ``hub-dominated''} vulnerability signature: the module graph's resilience depends on a small number of high-centrality hubs whose removal fragments the network far more effectively than chance would predict.
...
Under random removal, the giant component shrinks almost linearly---removing $20\%$ of nodes leaves $80\%$ connected. Under targeted attack (removing the highest-PageRank nodes first), $20\%$ removal reduces connectivity to $46\%$---a $34$-percentage-point gap. This is the classic signature of a scale-free\xinze{Same: ``scale-free'' $\to$ ``hub-dominated''} network~\cite{albert2000,barabasi1999}: resilient to random failure, vulnerable to targeted attack on hubs.
