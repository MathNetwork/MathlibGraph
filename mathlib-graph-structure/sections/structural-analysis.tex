...
Unless stated otherwise, module-level statistics are reported for both the raw import graph $G_{\mathrm{module}}$ and its transitive reduction $G_{\mathrm{module}}^{-}$, to distinguish genuine logical necessity from cognitive redundancy (\S\ref{sec:transitive-reduction}).
