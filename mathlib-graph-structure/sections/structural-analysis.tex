...
Do the three graphs share common statistical signatures, or does each level have its own structural character? The answer bears directly on the central tension of this paper: universal patterns---such as heavy-tailed degree distributions or hub-dominated vulnerability---point to intrinsic features of mathematical dependency (product), while level-specific features---such as the bounded out-degree of proofs or the depth compression of the module graph---reveal cognitive and linguistic constraints imposed by the production process.
