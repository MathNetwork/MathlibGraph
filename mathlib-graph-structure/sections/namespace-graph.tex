...
\begin{tikzpicture}[
  ...
  % ── Background: green fill for ns₁: Nat (all 5 decls) ──
  \fill[green!10, rounded corners=3pt]
    (0.0,-1.9) rectangle (6.7,1.4);

  % ── Blue module boxes (on top of green fill) ──
  \draw[blue!50!black, fill=blue!8, rounded corners=3pt, thick, dashed]
