...
\begin{tikzpicture}[
  ...
  modbox/.style={draw=blue!50!black, fill=blue!6, rounded corners=3pt,
                 inner sep=8pt, semithick, dashed},
  nsbox/.style={draw=green!50!black, fill=green!6, rounded corners=2pt,
                inner sep=5pt, semithick, dashed},
]
  % ── Module 1: Data.Nat.Basic (left, large) ──
  \node[modbox, minimum width=4.5cm, minimum height=3.4cm]
    (mod1) at (0,0) {};
  \node[font=\tiny\sffamily\bfseries, blue!60!black, anchor=north west]
    at ([xshift=2pt, yshift=-2pt]mod1.north west)
    {\textnormal{\module{Data.Nat.Basic}}};

  % Namespace Nat (green, inside mod1, top portion)
  \node[nsbox, minimum width=3.6cm, minimum height=1.2cm]
    (ns_nat1) at (0,0.55) {};
  \node[font=\tiny\sffamily, green!40!black, anchor=north west]
    at ([xshift=2pt, yshift=-1pt]ns_nat1.north west) {ns: Nat};
  ...
  % Namespace Nat.Primrec (green, inside mod1, bottom portion)
  \node[nsbox, minimum width=3.6cm, minimum height=0.8cm]
    (ns_pr) at (0,-1.0) {};
  \node[font=\tiny\sffamily, green!40!black, anchor=north west]
    at ([xshift=2pt, yshift=-1pt]ns_pr.north west) {ns: Nat.Primrec};
  \node[dot, label={[font=\tiny\ttfamily, red!70!black]right:zero}]
    (prz) at (-0.5,-1.0) {};

  % ── Module 2: Data.Nat.Defs (right) ──
  \node[modbox, minimum width=3.8cm, minimum height=2.0cm]
    (mod2) at (5.8,0.1) {};
  \node[font=\tiny\sffamily\bfseries, blue!60!black, anchor=north west]
    at ([xshift=2pt, yshift=-2pt]mod2.north west)
    {\textnormal{\module{Data.Nat.Defs}}};

  % Namespace Nat (green, inside mod2 -- same ns as in mod1!)
  \node[nsbox, minimum width=2.9cm, minimum height=1.2cm]
    (ns_nat2) at (5.8,0.1) {};
  \node[font=\tiny\sffamily, green!40!black, anchor=north west]
    at ([xshift=2pt, yshift=-1pt]ns_nat2.north west) {ns: Nat};
  ...
  % ── Legend ──
  \node[anchor=north west, font=\tiny\sffamily] at (-2.3,-2.1) {%
