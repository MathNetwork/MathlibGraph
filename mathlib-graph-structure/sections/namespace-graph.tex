...
The mechanism is visualized in Figure~\ref{fig:ns-depth-grouping} (\S\ref{sec:ns-decl-interaction}): as depth~$k$ increases, namespace boundaries split while module boundaries remain fixed, converting intra-namespace edges into cross-namespace edges and driving containment downward.
