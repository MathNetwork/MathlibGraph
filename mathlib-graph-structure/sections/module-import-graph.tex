...
\caption{In-degree and out-degree distributions on log--log axes, for $G_{\mathrm{import}}$ (left) and $G_{\mathrm{import}}^{-}$ (right). The dashed line shows a power-law reference $k^{-\gamma}$ fitted to the in-degree distribution; the deviation at high degrees indicates that the distribution is heavy-tailed but not a clean power law. Both distributions are heavy-tailed: most modules have small degree, while a few hub modules have degree exceeding~$100$.}
