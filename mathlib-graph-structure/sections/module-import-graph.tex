...
\caption{Number of modules at each topological level for $G_{\mathrm{import}}$ (top) and $G_{\mathrm{import}}^{-}$ (bottom). Level~$0$ contains the $1{,}433$ source modules; the depth extends to level~$153$.}
