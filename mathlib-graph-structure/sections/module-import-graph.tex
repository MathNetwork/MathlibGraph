...
Formalization makes them explicit, exhaustive, and computable. Yet the cognitive structure of mathematical practice does not vanish---it leaves traces in the formal record, as we shall see in the divergence between the import graph and its transitive reduction (\S\ref{sec:module_conclusion}).
