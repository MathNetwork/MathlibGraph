...
We now analyze the global structure of $G_{\mathrm{import}}$. Unless stated otherwise, statistics are reported for both the raw import graph $G_{\mathrm{import}}$ and its transitive reduction~$G_{\mathrm{import}}^{-}$.
