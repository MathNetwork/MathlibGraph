...
\]
One-third of the dependency traffic involving~$m$ stays internal. In Mathlib, the median module has $\mathrm{coh}(m) = 0$: \emph{no} internal traffic at all.
\end{example}
