...
XXXXX 
comprising 308,129 declarations, 8,436,366 dependency edges, 7,563 modules, and 153 levels of DAG depth (\S\ref{sec:dag-depth}). All statistics refer to commit \texttt{534cf0b} (2 Feb 2026), extracted using \texttt{importGraph} (module layer) and premise-extraction tooling (declaration layer).\xinze{LeanScout pipeline: could cross-validate}
