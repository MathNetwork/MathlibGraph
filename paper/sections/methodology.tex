...
Definitional height & $\delta(d)$ & Kernel-level implicit coupling & median $7$, max $60$ & \S\ref{sec:decl-metadata} \\
Import utilization & $\mathrm{util}(m_i, m_j)$ & Module granularity & median $1.6\%$ & \S\ref{sec:visibility-graph} \\
