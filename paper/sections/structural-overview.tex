\subsection{Structural and Cross-Level Properties}
...
\paragraph{Cross-Level Structural Comparison}
...
\subsubsection{Cross-Level Alignment}
\label{sec:cross-level-summary}

\paragraph{Module--Declaration Interaction}
...
\paragraph{Namespace--Declaration Interaction}
...
\paragraph{Three Layers Combined}
