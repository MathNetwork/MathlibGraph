...
\emph{Definitional heights have been extracted (Table~\ref{tab:decompositions}); the remaining analyses (tactic usage distributions, compilation-time correlations, universe polymorphism patterns) require additional data sources and are deferred to future work.}
