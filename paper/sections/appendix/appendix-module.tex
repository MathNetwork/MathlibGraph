...
Figure~\ref{fig:namespace-heatmaps} visualises the inter-directory import flow as heatmaps for the raw and transitively reduced module graphs.
...
\caption{Raw graph $G_{\mathrm{module}}$.}
