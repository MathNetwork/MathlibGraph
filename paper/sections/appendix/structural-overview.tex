...
Louvain modularity decreases from $0.64$ (module) to $0.48$ (declaration) to $0.27$ (namespace), reflecting progressively denser cross-boundary connectivity. Community--namespace alignment follows a parallel decline (NMI from $0.42$ to $0.26$). Only \ns{CategoryTheory} resists this trend, achieving $97.4\%$ community concentration at the declaration level, a unique degree of disciplinary self-containment (Appendix~\ref{sec:sa-community}).
