...
Louvain community detection (\S\ref{sec:prelim-community}) on the undirected, weighted projection of $G_{\mathrm{ns}}^{(2)}$ yields $12$ communities with modularity $Q = 0.271$.
...
0 & $1{,}227$ & \ns{CategoryTheory}, \ns{CategoryTheory.Functor}, \ns{CategoryTheory.CategoryStruct} \\
4 & $927$     & \ns{Real}, \ns{Complex}, \ns{NormedField} \\
1 & $462$     & \ns{Monoid}, \ns{Subgroup}, \ns{MulOneClass} \\
\bottomrule
\end{tabular}
