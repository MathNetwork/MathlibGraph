...
\begin{tikzpicture}[
  ...
  \node[font=\tiny\sffamily, text=blue!60!black] at (0,1.65) {module $A$};
  % Module B: d3, d5
  \node[modbox, minimum width=1.6cm, minimum height=1.6cm] at (2.8,0.6) {};
  \node[font=\tiny\sffamily, text=blue!60!black] at (2.8,1.65) {module $B$};
  % Intra-module edges
...
\begin{tikzpicture}[
  ...
  \node[font=\tiny\sffamily, text=green!50!black] at (0,1.65) {\ns{Nat}};
  % Namespace Nat.Prime (contains d3, d5)
  \node[nsbox, minimum width=1.6cm, minimum height=1.6cm] at (2.8,0.6) {};
  \node[font=\tiny\sffamily, text=green!50!black] at (2.8,1.65) {\ns{Nat.Prime}};
