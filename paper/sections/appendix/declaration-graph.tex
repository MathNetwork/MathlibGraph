...
\xinze{De Moura~\cite{demoura2026proofassistants} observes that leaf theorems are the connection points with external project libraries (FLT, PFR, Sphere Eversion, etc.). We could name these projects here and note that the 44.8\% leaf rate characterizes the size of Mathlib's \textbf{external API surface}.}
